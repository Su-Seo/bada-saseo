...
import { OceanUIContext } from "./OceanUIContext";
...
export default function OceanScene() {
  ...
  const floatingMessageIds = useMemo(
    () => new Set(bottles.map((b) => b.messageId)),
    [bottles]
  );
  ...
  return (
    <OceanBottlesProvider value={{ addMyBottle }}>
      <OceanUIContext.Provider value={oceanUIValue}>
        <div
