  ...
  return (
    <div className={`flex ${isSm ? "gap-2" : "gap-3"} items-start`}>
      ...
      <div className="flex flex-col items-center gap-1 pt-1 shrink-0">
        ...
        <span className="text-[0.45rem] text-white/25 tracking-wide text-center leading-tight">
          {isCustomColor ? value.bottleColor : value.bottleColor}
          <br />
          {PAPER_STYLE_MAP[value.paperStyle]?.label}
        </span>
      </div>
